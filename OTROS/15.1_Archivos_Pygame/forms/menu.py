...
def mostrar_menu(pantalla: pg.Surface, cola_eventos: list[pg.event.Event]) -> str:
    ...
    lista_botones[var.BOTON_JUGAR]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_JUGAR]['superficie'], (125, 175))
    lista_botones[var.BOTON_AJUSTES]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_AJUSTES]['superficie'], (125, 275))
    lista_botones[var.BOTON_HISTORIA]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_HISTORIA]['superficie'], (125, 375))
    lista_botones[var.BOTON_SALIR]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_SALIR]['superficie'], (125, 475))
    ...
    aux.mostrar_texto(lista_botones[var.BOTON_AJUSTES]['superficie'], 'AJUSTES', (75, 20), var.FUENTE_30, var.COLOR_BLANCO)
